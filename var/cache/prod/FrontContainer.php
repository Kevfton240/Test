...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/modules/productcomments/src/Entity']);
        $d->addExcludePaths([0 => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/src/PrestaShopBundle/Entity']), 'PrestaShop');
        $b->addDriver($d, 'PrestaShop\\Module\\ProductComment\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/modules/kjmodulebedrock/src/Entity']), ' PrestaShop\\Module\\kjmodulebedrock\\Entity');
        ...
        $a->setProxyDir('/Applications/MAMP/htdocs/prestashop_1.7.8.10/var/cache/prod//doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/Applications/MAMP/htdocs/prestashop_1.7.8.10/var/cache/prod//localization');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/app',
            'kernel.project_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.8.10',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/var/cache/prod/',
            ...
            'ps_cache_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/MAMP/htdocs/prestashop_1.7.8.10/var/cache/prod//doctrine/orm/Proxies',
